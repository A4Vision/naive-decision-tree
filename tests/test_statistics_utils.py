...
from tree.optimized_train.statistics_utils import estimate_expectancy_of_normal_from_samples
    ...
    for n in [10, 1000]:
        for confidence in [0.8, 0.9, 0.95]:
            ...
            for _ in range(N):
                ...
                estimate = estimate_expectancy_of_normal_from_samples(samples, confidence)
